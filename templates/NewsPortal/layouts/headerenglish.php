                ...
                <div class="container" style="padding: 0">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            ...
                            <li class="nav-eng dropdown">
                                ...
                                <li class="nav-eng dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        ...
                                        <a class="dropdown-item" href="#">State 4</a>
                                        <a class="dropdown-item" href="#">State 5</a>
                                        <a class="dropdown-item" href="#">State 6</a>
                                        <a class="dropdown-item" href="#">State 7</a>
                                    </div>
                                </li>
                                <li class="nav-eng">
                                    <a class="nav-link" href="antarastriya-english.php">International</a>
                                </li>
                                <li class="nav-eng">
                            ...
                            <a href="unicodeenglish.php" class="btn btn-danger unicode"><i class="fa fa-keyboard-o"></i> Unicode</a>
                        </div>
